...
urlpatterns = [
    ...
    path(
        'download-test-form/<int:test_id>/',
        views.download_test_form,
        name='download_test_form'
    ),

    path(
        'download-vaccine-form/<int:vaccine_id>/',
        views.download_vaccine_form,
        name='download_vaccine_form'
    ),
    ...
    path(
        'records/checkout/<int:pk>/',
        views.checkout_record,
